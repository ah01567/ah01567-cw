class DepartmentsController < ApplicationController
  ...
  before_action :set_uni, only: [:new, :create]
  before_action :authenticate_student!
  # GET /departments
  # GET /departments.json
  def index
    @departments = Department.student_departments(current_student)
  end
  ...
  # GET /departments/new
  def new
    @department = @uni.departments.new
  end
  ...
  def create
    @department = @uni.departments.new(department_params)
